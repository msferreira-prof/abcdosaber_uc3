...
class Turma(models.Model):
    ...
    codigo_atividade = models.ForeignKey(TipoDeAtividade, on_delete=models.CASCADE, related_name='atividades',)
    matricula_monitor = models.ForeignKey(Aluno, null=True, blank=True, on_delete=models.SET_NULL, related_name='alunos',)
    id_instrutor = models.ForeignKey(Instrutor, null=True, on_delete=models.CASCADE, related_name='instrutores',)
...
class TurmaAluno(models.Model):
    ...
    matricula_aluno = models.ForeignKey(Aluno, on_delete=models.CASCADE, related_name='alunos_turmas',
